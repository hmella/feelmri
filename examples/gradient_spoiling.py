...
if __name__ == '__main__':
  ...
  # 7.0 ppm of the main field. The normalisation above leaves the peak at
  ...
  delta_B0 = delta_B0 * scanner.field_strength * 7.0e-6
  ...
  # Set static fields
  phantom.set_static_fields(T2=T2, phi_dB0=delta_omega0.m_as('rad/ms'))
