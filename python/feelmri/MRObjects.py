...
# Re-exported so `from feelmri.MRObjects import B0Field` keeps resolving. The
# field is a property of the scanner rather than a piece of transmit hardware,
# and at ~1000 lines it was half of this module; it has its own now.
from feelmri.B0Field import (  # noqa: F401
    B0Field, NoPolynomialFits, ReadoutTerms, SolverTerms)
